            ...
            return (
                <div className="row" key={comment.id}>
                    <div className="col s8 l6">
                        <p >{comment.authorFirstName} {comment.authorLastName}: {comment.content}</p>
                    </div>
                    <div className="col s2 l5 offset-l1 offset-s2">
                        <p className="grey-text text-lighten-1 right  ">{moment(comment.createdAt.toDate()).calendar()}</p>
                    </div>
            ...
            <div className="card z-depth-0">
                <div className="card-content">
                    <span className="card-title center green-text text-darken-1">
                        <h4>{project.authorFirstName} {project.authorLastName}</h4>
                    </span>
                    <p>{project.content}</p>
                        ...
                        <div className="row">
                            ...
                            <div className="input-field">
                                <div className="col s10 l9">
                                    ...
                                    <textarea id={"message" + project.id} className="materialize-textarea" onChange={this.handleChange} value={this.state.text}></textarea>
                                    <label htmlFor={"message" + project.id}>Your comment</label>
                                </div>
                                <div className="s2 l3">
                                    <button className="btn btn-small right">send
